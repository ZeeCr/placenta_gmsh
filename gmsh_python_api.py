...
# This file defines the Gmsh Python API (v4.11.0).
#
...
# Check a point is inside an OCC curve, surface or volume
    @staticmethod
...
# !! Get curve loop tags making up surface
        @staticmethod
        ...
        get_mass = getMass
# Average over geometry to find centre
        @staticmethod
